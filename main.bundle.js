...
// Module
exports.push([module.i, "/* This is an example of using Sass, otherwise plain CSS works too*/\n.clearfix:after {\n  content: ' ';\n  display: table;\n  clear: both; }\n\n*,\n*:after,\n*:before {\n  box-sizing: border-box; }\n\n.main_guest, .main_manager {\n  float: right;\n  grid-area: main;\n  position: relative; }\n\n.body_portal {\n  background-color: #59B2C2;\n  display: grid;\n  grid-template-areas: \"aside header\" \"aside main\";\n  grid-template-columns: 30% 70%;\n  grid-template-rows: 20% 80%; }\n\n.header_guest-page, .header_manager-page {\n  float: right;\n  grid-area: header;\n  text-align: center; }\n\n.div_guest-bookings, .div_selected-user-bookings {\n  background-color: #dbdaf1;\n  color: #3d3795; }\n\n.div_available-rooms {\n  background-color: #dbdaf1;\n  border: 2px solid black;\n  color: #3d3795;\n  margin: 5px;\n  padding: 10px; }\n\n.login-page-body {\n  background-color: black;\n  color: #fff; }\n\nimg {\n  display: inline;\n  width: 75%; }\n\nh1 {\n  font-size: 3em;\n  text-align: center; }\n\nh2,\nh3 {\n  color: #3d3795; }\n\n.main_login-page {\n  display: flex; }\n\n.div_button-container {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  padding: 15px;\n  width: 25%; }\n\nbutton {\n  border-radius: 3px;\n  padding: 15px;\n  margin: 10px;\n  border: 2px solid #3d3795;\n  border-radius: 3px;\n  cursor: pointer;\n  font-size: 1.2em;\n  margin: 25px auto;\n  padding: 10px;\n  width: 80%; }\n  button:hover, button:focus {\n    outline: #3d3795 solid 4px; }\n\n.button_new-search {\n  border-radius: 3px;\n  padding: 15px;\n  margin: 10px;\n  border: 2px solid #3d3795;\n  width: 20%; }\n\n.submit_book-room {\n  border-radius: 3px;\n  padding: 15px;\n  margin: 10px;\n  border: 2px solid #3d3795;\n  width: 175px;\n  font-size: 1em;\n  font-weight: bold;\n  cursor: pointer; }\n\nform {\n  display: flex;\n  flex-direction: column; }\n\ninput {\n  border-radius: 3px;\n  padding: 15px;\n  margin: 10px;\n  border: 2px solid #3d3795;\n  width: 175px;\n  font-size: 1em;\n  font-weight: bold;\n  cursor: pointer; }\n  input:hover, input:focus {\n    outline: #3d3795 solid 4px; }\n\nlabel {\n  font-size: 1.4em; }\n\n.header_guest-page {\n  border-radius: 3px;\n  padding: 15px;\n  margin: 10px;\n  border: 2px solid #3d3795;\n  background-color: white; }\n  .header_guest-page h1 {\n    margin: 20px;\n    color: #3d3795; }\n\n.aside_guest-page {\n  border-radius: 3px;\n  padding: 15px;\n  margin: 10px;\n  border: 2px solid #3d3795;\n  background-color: white;\n  grid-area: aside; }\n\n.main_guest {\n  border-radius: 3px;\n  padding: 15px;\n  margin: 10px;\n  border: 2px solid #3d3795;\n  background-color: white;\n  height: 95vh;\n  overflow: scroll;\n  text-align: center; }\n\n.guest-dashboard-booking-list {\n  height: 90vh;\n  overflow: scroll; }\n\n.div_guest-bookings {\n  border-radius: 3px;\n  padding: 15px;\n  margin: 10px;\n  border: 2px solid #3d3795; }\n\n.div_available-rooms {\n  border-radius: 3px;\n  padding: 15px;\n  margin: 10px;\n  border: 2px solid #3d3795; }\n\n.header_manager-page {\n  border-radius: 3px;\n  padding: 15px;\n  margin: 10px;\n  border: 2px solid #3d3795;\n  background-color: white; }\n  .header_manager-page h1 {\n    color: #3d3795; }\n\n.aside_manager-page {\n  border-radius: 3px;\n  padding: 15px;\n  margin: 10px;\n  border: 2px solid #3d3795;\n  background-color: white;\n  grid-area: aside; }\n\n.main_manager {\n  background-color: #59B2C2;\n  border: none;\n  display: flex;\n  margin: 0;\n  padding: 0; }\n\n.div_main {\n  border-radius: 3px;\n  padding: 15px;\n  margin: 10px;\n  border: 2px solid #3d3795;\n  background-color: white;\n  height: 90vh;\n  overflow: scroll;\n  text-align: center;\n  width: 50%; }\n\n.ul_guest-search-matches {\n  font-size: 1.6em;\n  list-style: none;\n  padding: 0; }\n\n.button_searched-user-name {\n  border: 2px solid #3d3795;\n  cursor: pointer;\n  font-size: .7em;\n  margin: 5px;\n  padding: 5px;\n  width: 80%; }\n  .button_searched-user-name:hover, .button_searched-user-name:focus {\n    outline: #3d3795 solid 4px; }\n\n.div_selected-user-bookings {\n  border-radius: 3px;\n  padding: 15px;\n  margin: 10px;\n  border: 2px solid #3d3795; }\n  .div_selected-user-bookings h4,\n  .div_selected-user-bookings p {\n    margin: 8px;\n    font-size: .7em; }\n\nselect {\n  border-radius: 3px;\n  padding: 15px;\n  margin: 10px;\n  border: 2px solid #3d3795;\n  width: 175px;\n  font-size: 1em;\n  font-weight: bold;\n  cursor: pointer;\n  height: 53px;\n  margin: 10px; }\n  select:hover, select:focus {\n    outline: #3d3795 solid 4px; }\n\n.error {\n  color: red;\n  font-size: 1.3em; }\n\n.error_select-guest {\n  font-size: 2em;\n  font-weight: bold; }\n\n.div_dashboard {\n  border-radius: 3px;\n  padding: 15px;\n  margin: 10px;\n  border: 2px solid #3d3795;\n  align-items: center;\n  display: flex;\n  flex-direction: column;\n  text-align: center; }\n\n.section_dashboard {\n  border-radius: 3px;\n  padding: 15px;\n  margin: 10px;\n  border: 2px solid #3d3795;\n  padding: 5px;\n  width: 90%; }\n\n.div_available-rooms {\n  border-radius: 3px;\n  padding: 15px;\n  margin: 10px;\n  border: 2px solid #3d3795; }\n\n.hide {\n  display: none; }\n\n@media screen and (max-width: 875px) {\n  .main_login-page {\n    display: grid; }\n  .button_guest-login,\n  .button_manager-login {\n    margin: 5px auto 5px auto;\n    width: 40%; }\n  .div_button-container {\n    padding: 0;\n    width: 100%; }\n  .img_background {\n    margin: 10px auto 10px auto;\n    width: 90%; }\n  .aside_manager-page {\n    border-radius: 3px;\n    padding: 15px;\n    margin: 10px;\n    border: 2px solid #3d3795;\n    align-items: center;\n    background-color: white;\n    display: flex;\n    flex-direction: row;\n    grid-area: aside;\n    justify-content: space-between; }\n  .section_dashboard {\n    width: 23%; }\n  .body_manager-page {\n    background-color: #59B2C2;\n    display: grid;\n    grid-template-areas: \"header header\" \"aside aside\" \"main main\";\n    grid-template-columns: 50% 50%;\n    grid-template-rows: 15% 15% 70%; }\n  .body_guest-page {\n    background-color: #59B2C2;\n    display: grid;\n    grid-template-areas: \"header header\" \"aside main\";\n    grid-template-columns: 45% 55%;\n    grid-template-rows: 12% 88%; }\n  .header_guest-page h1 {\n    font-size: 2em;\n    margin: 0; }\n  .aside_guest-page .section_dashboard {\n    margin: 3px;\n    width: 100%; }\n    .aside_guest-page .section_dashboard .div_guest-bookings {\n      margin: 3px; } }\n\n@media screen and (max-width: 530px) {\n  .button_guest-login,\n  .button_manager-login {\n    margin: 5px auto 5px auto;\n    width: 90%; }\n  .body_manager-page,\n  .body_guest-page {\n    display: flex;\n    flex-direction: column; }\n  .main_manager {\n    display: flex;\n    flex-direction: column; }\n    .main_manager div {\n      width: 95%; }\n  .aside_manager-page {\n    display: flex;\n    flex-direction: column;\n    flex-wrap: wrap; }\n    .aside_manager-page h2 {\n      width: 90%;\n      margin: 0; }\n  .header_manager-page h1 {\n    font-size: 2em;\n    margin: 0;\n    padding: 0; }\n  .section_dashboard {\n    width: 90%; }\n    .section_dashboard h3,\n    .section_dashboard p {\n      margin: 0; } }\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = (TapeChart);
...
module.exports = "images/concierge.jpg";
...
/* harmony import */ var _TapeChart_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./TapeChart.js */ "./src/TapeChart.js");
/* harmony import */ var _images_concierge_jpg__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./images/concierge.jpg */ "./src/images/concierge.jpg");
/* harmony import */ var _images_concierge_jpg__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_images_concierge_jpg__WEBPACK_IMPORTED_MODULE_4__);
...
Promise.all([bookingData, roomData, userData]).then((promise) => {
  ...
  tapeChart = new _TapeChart_js__WEBPACK_IMPORTED_MODULE_3__["default"](userData, roomData, bookingData);
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#button_guest-login').on('click', function() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#form_guest-login').toggleClass('hide');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#button_team-member-login').toggleClass('hide');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#error_login-js').addClass('hide');
})

jquery__WEBPACK_IMPORTED_MODULE_0___default()('#button_team-member-login').on('click', function() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#form_team-member-login').toggleClass('hide');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#button_guest-login').toggleClass('hide');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#error_login-js').addClass('hide');
})

jquery__WEBPACK_IMPORTED_MODULE_0___default()('#submit_guest').on('click', function(event) {
  event.preventDefault();
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('#guest-login').val().includes('customer') &&
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#guest-password').val() === 'overlook2019') {
      userLogin = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#guest-login').val();
      localStorage.setItem('userLogin', userLogin);
      window.location = "./customer.html";
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#error_login-js').removeClass('hide');
  }
})

jquery__WEBPACK_IMPORTED_MODULE_0___default()('#submit_team-member').on('click', function(event) {
  event.preventDefault();
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('#team-member-login').val() === 'manager'
    && jquery__WEBPACK_IMPORTED_MODULE_0___default()('#team-member-password').val() === 'overlook2019') {
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#button_find-room-js').on('click', function(event) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.div_available-rooms').remove();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.error_no-rooms').addClass('hide');
  selectedDate = formatSelectedDate(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#select-date').val());
  let roomType = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#select-room-type').val();
  if (selectedDate !== ''
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.error_no-rooms').removeClass('hide');
  }
})

jquery__WEBPACK_IMPORTED_MODULE_0___default()('.button_clear-search').on('click', function() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.div_available-rooms').remove();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#select-date').val('');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#select-room-type').val('any');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.error_no-rooms').addClass('hide');
})

// CREATE AND POST NEW BOOKING FOR USER
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.main_portal-page').on('click', '.button_book-now', function(event) {
  let postBody;
  let roomNum = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('roomnumber');
  let captureThis = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
  if (window.location.pathname === '/customer.html') {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.error_select-guest').removeClass('hide');
  }
})

// SEARCH USERS BY NAME
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#input_search-guest').on('keyup', function() {
  selectedUser = null;
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ul_guest-search-matches').html('')
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.error_select-guest').addClass('hide');
  let searchSoFar = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#input_search-guest').val().toLowerCase();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ul_guest-search-matches').html('');
  let foundUsers = tapeChart.findUserFromSearch('name', searchSoFar);
  if (foundUsers.length > 0 && searchSoFar.length > 0) {
    foundUsers.forEach(user => {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ul_guest-search-matches').append(
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ul_guest-search-matches').on('click', '.button_searched-user-name', function() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.error_select-guest').addClass('hide');
  let userName = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('guestname');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ul_guest-search-matches').html(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this));
  let userInfo = tapeChart.findUser('name', userName)

  selectedUser = new _User_js__WEBPACK_IMPORTED_MODULE_2__["default"](userInfo[0], tapeChart);

  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.span_selected-guest').text(`${selectedUser.name.split(' ')[0]}`)
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ul_guest-search-matches').append(`
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#button_cancel-js').on('click', function() {
  let confirmationNum = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#input_cancel-booking').val();
  if (selectedUser.getBookingIDs().includes(Number(confirmationNum))) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.error_wrong-conf').removeClass('hide');
  }
})
...
function loadManagerPageDisplay() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#manager-dashboard-occupancy').text(`${tapeChart.getOccupancy(today)}%`);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#manager-dashboard-revenue').text
    (`$${tapeChart.getDaysRevenue('date', today)}`);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#manager-dashboard-availability').text
...
function loadGuestPageDisplay() {
  ...
  user = new _User_js__WEBPACK_IMPORTED_MODULE_2__["default"](foundUser[0], tapeChart);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.span_user-name').text(`${user.name}`);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.span_user-first-name').text(`${user.name.split(' ')[0]}`);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#guest-dashboard-spending').text(`${user.mySpending} points`);
  user.myBookings.forEach(booking => {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#guest-dashboard-bookings').append(`
...
function displayAvailableRooms(date, roomType, where) {
  ...
  if (availableRooms.length === 0) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.error_no-rooms')
      .removeClass('hide')
  } else {
    availableRooms.forEach(room => {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(where).append(
...
function displayBookingSuccess(param) {
  ...
  setTimeout(function(){
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.toRemove').remove();
  }, 2500);
}

function displayCancel(confNum) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(`#${confNum}`).append(`
    <h4>BOOKING CANCELLED<h4>CANCELLATION # ${Date.now()}</h4>`);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.error_wrong-conf').addClass('hide');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#input_cancel-booking').val('');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#input_cancel-booking').attr("placeholder", confNum);
}
